/**
 * Canonical Athena skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$ATHENA_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`athena_cli/skin_engine.py`),
 ...
 *   • CLI     → `athena_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
