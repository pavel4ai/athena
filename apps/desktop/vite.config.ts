...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\athena\athena-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@athena/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@athena/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@athena/shared': path.resolve(__dirname, '../shared/src'),
