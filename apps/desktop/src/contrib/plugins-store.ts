 ...
 * `<athena home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'athena.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'athena.desktop.disabledPlugins.v1'
