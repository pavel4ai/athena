...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverride: '環境變數覆寫',
      intro:
        'Athena Desktop 預設會啟動自己的本機閘道。如果您希望此應用程式控制另一台機器或可信代理後面已執行的 Athena 後端，請使用遠端閘道。在下方按設定檔指定各自的遠端主機。',
      appliesTo: '套用至',
      allProfiles: '全部設定檔',
  ...
  updates: {
    ...
    applyingBody: 'Athena 更新程式會在自己的視窗中接管，並在完成後自動重新開啟 Athena。更新期間請勿自行重新開啟 Athena。',
