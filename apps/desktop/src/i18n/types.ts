...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshAthenaPathTitle: string
      sshAthenaPathDesc: string
      sshAthenaPathPlaceholder: string
  ...
  commandCenter: {
    ...
    athenaActiveSessions: (version: string, count: number) => string
