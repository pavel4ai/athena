...
export const en: Translations = {
  connectors: {
    ...
    disclaimer: 'Connecting is optional. Only authorize the apps you want Athena to use.',
    execution: 'Connector tools'
  },

  sessionImport: {
    title: 'Continue from another app',
    subtitle: 'Bring a conversation into Athena and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Athena.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Athena. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Athena',
    continue: 'Continue in Athena',
  ...
  boot: {
    ready: 'Athena Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Athena settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Athena backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingAthenaDesktop: 'Starting Athena Desktop…'
    },
    errors: {
      backgroundExited: 'Athena background process exited.',
      backgroundExitedDuringStartup: 'Athena background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Athena backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateAthena: 'Update Athena',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Athena Desktop.',
    ...
    native: {
      ...
      inputBody: 'Athena is waiting for your response.',
      turnDoneTitle: 'Athena finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `athena debug share --nous` from a terminal, or `athena debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Athena defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Athena catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, Athena generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; Athena picks it up automatically.`,
        disabledDesc: 'Detected but turned off for Athena.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when Athena closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Athena is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Athena asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Athena was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Athena was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Athena follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Athena can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Athena when it helps. Each tip appears once.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Athena walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Athena is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Athena, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The Athena runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Athena only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Athena',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Athena checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Athena configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Athena.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Athena gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Athena Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Athena Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Athena runtime managed by this app.',
      kindRemoteDesc: 'A Athena gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Athena Cloud account.',
      kindSshDesc: 'A Athena install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Athena manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Athena Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Athena backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset ATHENA_DESKTOP_REMOTE_URL and ATHENA_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Athena backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Athena backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Athena Cloud',
      cloudDesc: 'Sign in once to Athena Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Athena Cloud',
      cloudSignIn: 'Sign in to Athena Cloud',
      cloudSignedIn: 'Signed in to Athena Cloud',
      cloudNeedsSignIn: 'Sign in to Athena Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Athena Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Athena Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Athena Cloud',
      cloudSignedOutMessage: 'Cleared the Athena Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /athena.',
      ...
      restartingMessage: 'Athena Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Athena ${version}` : ''}`,
      ...
      sshDesc:
        'Athena is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshAthenaPathTitle: 'Athena path (optional)',
      sshAthenaPathDesc: 'Full path to the remote athena binary. Blank = auto-detect.',
      sshAthenaPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Athena found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Athena runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Athena is not installed on the remote host. Install it there (curl -fsSL https://athena-agent.nousresearch.com/install.sh | sh) or set the Athena path.',
      sshErrPlatform:
        'Unsupported remote platform. Athena Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Athena on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Athena. Review the exact configuration below — it comes from the link, not from Athena.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Athena starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build Athena ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Athena runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Athena at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Athena browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via athena curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update Athena to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the Athena catalog${sha ? ` at pin ${sha}` : ''}.`,
  ...
  starmap: {
    ...
    emptyDesc: 'As Athena builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Athena to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Athena to generate pets.',
      backgroundHint: 'You can close this — Athena will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Athena desktop' },
    ...
    athenaActiveSessions: (version, count) => `Athena ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle: 'Both options connect a bot you control and save its credentials only to this Athena installation.',
      quickSetup: 'Quick setup',
      recommended: 'Recommended',
      quickHelp:
        'Scan a QR code and confirm in Telegram. Athena creates the bot and detects your Telegram user ID automatically.',
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@athena:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Athena you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://athena.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Athena environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Athena did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Athena will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Athena backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Athena. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Athena backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Athena...',
    placeholderReconnecting: 'Reconnecting to Athena…',
    ...
    attachUrlDesc: 'Athena will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Athena to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Athena…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Athena…',
    ...
    unsupportedMessage: 'This version of Athena can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Athena from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Athena will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Athena desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Athena updater takes over in its own window and reopens Athena automatically when it’s done. Please don’t reopen Athena yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Athena reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Athena reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Athena?',
    blockerBody:
      'Athena needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Athena',
    foreignBlockerBody:
      'Athena can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Athena can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  guidedGreeting: {
    line: "Hey, come on in. I'm Athena. Give me two minutes to set the place up around you, then we'll put me to work on something you actually want done.\n\nFirst though, what should I call you?",
  ...
  install: {
    ...
    oneTimeTitle: 'Athena needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Athena Desktop',
    setupChoiceDesc:
      'Connect this app to a Athena gateway you already run, or install Athena locally on this computer.',
    connectExistingTitle: 'Connect to existing Athena',
    ...
    installLocalTitle: 'Install Athena locally',
    installLocalDesc: 'Download Athena, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Athena Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Athena',
    remoteSetupDesc: 'Enter your gateway URL. Athena Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Athena gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/athena',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Athena gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Athena CLI or desktop instance is running. Stop any running Athena instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    ...
    preparingInstall: 'Athena is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Athena…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Athena',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Athena at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Athena connects automatically',
    ...
    authorizeThere: 'Authorize Athena there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Athena there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  freeTier: {
    ...
    alreadySignedInBody: 'This Athena is already signed in to a Nous account.'
  },
  ...
  shell: {
    ...
    statusbar: {
      ...
      connectionCloudTooltip: host => `Athena Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Athena will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Athena is restarting...',
      askRestart: 'Ask Athena to restart the server',
      lookingRestart: taskId => `Athena is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Athena is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Athena to open a page.',
      finishedRestarting: message => `Athena finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Athena could not restart the server.',
      stillWorking:
        'Athena is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Athena is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Athena gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.athena/config.yaml). Athena won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Athena needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Athena needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `Athena reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and Athena types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and Athena enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Athena Desktop to use Save Image.',
    restartToSaveImages: 'Restart Athena Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `athena gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Athena loads when the work calls for them.'
      },
      messaging: {
        title: 'Athena away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Athena made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Athena — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
