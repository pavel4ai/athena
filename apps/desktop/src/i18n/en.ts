...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Athena Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Athena backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      remoteDesc:
        'Connect this desktop shell to a remote Athena backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Athena Desktop will reconnect using the saved settings.',
  ...
  onboarding: {
    ...
    flowSubtitles: {
      ...
      loopback: 'Opens your browser to sign in — Athena connects automatically',
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Athena inference gateway status',
      agents: 'Agents',
