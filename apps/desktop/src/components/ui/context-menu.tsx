...
export const ATHENA_CONTEXT_MENU_TRIGGER_ATTR = 'data-athena-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-athena-context-menu-trigger="" />
  )
}
