...
const STORAGE_KEY = 'athena.desktop.layoutTree.v2'

writeKey('athena.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('athena.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('athena.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'athena.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'athena.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'athena.desktop.hiddenStripTabs.v1'
...
writeKey('athena.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__ATHENA_LAYOUT_TREE__ = {
    close: closeTreePane,
