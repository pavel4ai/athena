...
/**
 * Nous — the canonical Athena desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Athena's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Athena desktop identity: GitHub's chrome carrying Nous
