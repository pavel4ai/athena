/**
 * Athena skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$ATHENA_HOME/skins/` (or a
 * built-in) resolved by `athena_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Athena authors from a prompt lights up all three surfaces from one file.
 *
...
import type { AthenaSkin, SkinColors } from '@athena/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: AthenaSkin): DesktopTheme | null {
