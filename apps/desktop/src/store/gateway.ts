import type { ConnectionState, GatewayEvent } from '@athena/shared'
...
export const $gateway = atom<AthenaGateway | null>(null)
...
let primaryGateway: AthenaGateway | null = null
