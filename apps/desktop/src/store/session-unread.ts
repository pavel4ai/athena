...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('athena.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('athena.desktop.unreadFinishedSessions')
