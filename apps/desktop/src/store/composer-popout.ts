...
const POPOUT_STORAGE_KEY = 'athena.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'athena.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'athena.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'athena.desktop.composerPopout.position'
