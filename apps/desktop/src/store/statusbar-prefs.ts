...
// v1 (`athena.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'athena.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'athena.desktop.statusbarHidden'
// v1 (`athena.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'athena.desktop.statusbarVisible.v2'
