...
function identityForConnection(connection: AthenaConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: AthenaConnection | null): void {
