...
export interface PetInfo {
  ...
  // the Athena "run" activity state uses the in-place running row).
 ...
 * ATHENA_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'athena.desktop.pet-roam.v1'
