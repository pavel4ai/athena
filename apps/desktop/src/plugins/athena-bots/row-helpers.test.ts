 ...
 *    the primary profile surfaced as @default instead of @athena;
 ...
 *    kanban/tool workers count too (athena-agent#90268): a profile grinding
...
describe('previewKind classifies a roster preview', () => {
  ...
  it('surfaces the primary profile as @athena, never @default (#89484)', () => {
    expect(fromBot("Message from agent 'default': deploy is green")).toBe('athena')
