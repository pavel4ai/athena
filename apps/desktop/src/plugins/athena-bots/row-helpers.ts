...
import { atom, host, useValue } from '@athena/plugin-sdk'
...
export function previewKind(preview: null | string | undefined): { fromBot: null | string } {
  ...
  if (match) {
    ...
    // profile reads @athena, never @default (#89484).
 ...
 *  (athena-agent#90268). Older gateways omit worker_session — always false. */
