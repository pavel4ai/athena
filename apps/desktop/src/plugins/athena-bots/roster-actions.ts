...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@athena/plugin-sdk'
 ...
 *  (athena-agent#90102) and are discarded. Without `canonical_session` (older
