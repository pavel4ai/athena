...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/athena-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'athena_cli/config_defaults.py'), 'utf8')
