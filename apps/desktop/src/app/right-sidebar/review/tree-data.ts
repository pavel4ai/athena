import type { AthenaReviewFile } from '@/global'
...
export function buildReviewFlatList(files: AthenaReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: AthenaReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
