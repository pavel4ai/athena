...
const TAKEOVER_KEY = 'athena.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Athena can't clear via the API — the user
 *  sees exactly what runs instead of Athena silently deleting their creds. */
