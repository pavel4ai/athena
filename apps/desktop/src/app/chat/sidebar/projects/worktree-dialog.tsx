...
import type { AthenaGitBranch } from '@/global'
...
const branchActionLabel = (branch: AthenaGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<AthenaGitBranch[]>([])
  ...
  const convert = async (branch: AthenaGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
