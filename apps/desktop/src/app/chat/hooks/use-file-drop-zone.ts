...
import { type DroppedFile, extractDroppedFiles, ATHENA_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, ATHENA_PATHS_MIME) ? 'files' : null
