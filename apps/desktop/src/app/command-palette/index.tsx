...
// Athena session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-athena',
            keywords: ['update', 'upgrade', 'athena', 'version', 'system', 'restart'],
            label: cc.updateAthena,
