...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/athena'
...
const VERSION = 3
const PREFIX = 'HML' // "Athena Memory Loadout" — namespaces our codes like WoW's leading bytes.
