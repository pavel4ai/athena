...
import type { AuxiliaryModelsResponse, ModelOptionProvider, StaleAuxAssignment } from '@/athena'
...
// Athena' reasoning levels (VALID_REASONING_EFFORTS); `none` = thinking off.
// Empty config = Athena default (medium), shown as Medium.
