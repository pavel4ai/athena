...
import { getAthenaConfigRecord, type AthenaGateway, saveAthenaConfig } from '@/athena'
...
function getServers(config: AthenaConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveAthenaConfig(nextConfig)
