...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/athena'
 ...
 * log inline — the GUI equivalent of the install step `athena tools` runs
