...
function fontFamilyFromConfig(config: AthenaConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useAthenaConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<AthenaConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setAthenaConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="athena-terminal-font-families"
          ...
          <datalist id="athena-terminal-font-families">
