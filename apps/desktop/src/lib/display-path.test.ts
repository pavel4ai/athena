...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/athena-agent')).toBe('~/www/athena-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/athena-agent')).toBe('athena-agent')
    expect(pathLeaf('~/www/athena-agent')).toBe('athena-agent')
