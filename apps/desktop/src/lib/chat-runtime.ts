...
import type { ModelOptionsResponse, SessionInfo } from '@/types/athena'
 ...
 *
 * Only the leading status prefix (e.g. "Athena is thinking...") and the
 ...
 *  resolved comment as JSON (AthenaPrComment shape); a malformed payload falls
