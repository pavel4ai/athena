...
declare global {
  interface Window {
    athenaDesktop: {
      ...
      getConnection: (profile?: string | null) => Promise<AthenaConnection>
      ...
      worktrees?: (cwds: string[]) => Promise<Record<string, AthenaWorktreeInfo | null>>
      terminal: {
...
export interface AthenaWorktreeInfo {
