...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @athena/plugin-sdk (+ react), never `@/…`
      ...
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@athena/shared'],
              message: 'Plugins import only @athena/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
