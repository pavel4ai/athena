...
cd apps/desktop
XCURSOR_SIZE=24 ATHENA_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/athena-typing
# → /tmp/athena-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/athena-typing.before.heapsnapshot
# → /tmp/athena-typing.after.heapsnapshot
```
