 ...
 * startAthena() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startAthena() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startAthena`, re-emits
