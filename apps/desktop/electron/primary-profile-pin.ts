 ...
 *     it via `athena:profile:remember` without re-homing the primary.
 ...
 * the same ATHENA_HOME. That duplicate held a pool slot and starved every other
...
export class PrimaryProfilePin {
  ...
  /** Called by startAthena() with the profile the primary is launching as. */
