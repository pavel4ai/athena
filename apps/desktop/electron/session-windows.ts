...
// by main.ts (`setBackgroundThrottling` driven by the merged `athena:active-work`
...
// (the "Athena idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Athena" wake word has NO preceding click,
