 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `athena_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Athena Teal",
  description: "Classic dark teal — the canonical Athena look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Athena look, ported from the
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Athena Teal (Large)",
  description: "Athena Teal with bigger fonts and roomier spacing",
