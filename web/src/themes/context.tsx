...
const STORAGE_KEY = "athena-dashboard-theme";
...
const FONT_STORAGE_KEY = "athena-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `athena_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "athena-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-athena-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-athena-theme-font", "true");
