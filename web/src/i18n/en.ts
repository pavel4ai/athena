...
export const en: Translations = {
  ...
  status: {
    ...
    updateAthenaConfirmMessage:
      "This runs athena update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateAthenaConfirmNow: "Update now",
    updateAthenaConfirmTitle: "Update Athena?",
    updatingAthena: "Updating Athena…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Athena plugins (`athena plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.athena/plugins/?",
    removeHint: "Only user-installed plugins under ~/.athena/plugins can be removed.",
    ...
    catalogEmptyDocsLink: "Learn about Athena plugins",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.athena/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Athena doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Athena Achievements",
      subtitle:
        "Collectible Athena badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Athena session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Athena more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Athena sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Athena is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
