 ...
 *
 * Values mirror athena_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Athena default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Athena' default when unset). */
