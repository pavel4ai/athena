import { buildAthenaWebSocketUrl } from "@athena/shared";
...
export async function buildWsUrl(
  ...
  return buildAthenaWebSocketUrl({
...
export interface StatusResponse {
  ...
  /** NS-656: disk-usage rollup for the ATHENA_HOME volume. Absent on
   * older gateways. */
 ...
 * sample of the ATHENA_HOME volume — no staleness dimension, so no
 * sampled_at. */
