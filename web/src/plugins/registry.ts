 ...
 *
 * Plugins call window.__ATHENA_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__ATHENA_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__ATHENA_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ATHENA_PLUGIN_SDK__ = {
    ...
    // window.__ATHENA_SESSION_TOKEN__ directly.
    authedFetch,
