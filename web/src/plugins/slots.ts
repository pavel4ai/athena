 ...
 * `window.__ATHENA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Athena brand in the top bar
 ...
 *  `window.__ATHENA_PLUGINS__.registerSlot(...)`.
 *
