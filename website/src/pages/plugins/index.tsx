...
const CATALOG_README_URL =
  "https://github.com/pavel4ai/athena/tree/main/plugin-catalog";
      ...
      <div className={styles.cardInner}>
        ...
        {expanded && (
          <div className={styles.cardDetail}>
            ...
            {plugin.requiresAthena && (
              <div className={styles.metaRow}>
                <span className={styles.metaLabel}>Requires</span>
                <span className={styles.metaValue}>
                  <code>athena {plugin.requiresAthena}</code>
                </span>
              </div>
            )}
            <div className={styles.metaRow}>
...
export default function PluginCatalogPage() {
  ...
  // (Athena desktop's Capabilities > Plugins tab) as a one-click catalog
  // picker. Site chrome is hidden via CSS and every card gains an
  // "+ Add to this Agent" button that posts
  //   { type: 'athena-plugin-pick', name, repo, sha, subdir, tier,
  //     installCmd }
    ...
    window.parent.postMessage(
      {
        ...
        tier: plugin.tier,
        installCmd: plugin.installCommand || `athena plugins install ${plugin.name}`,
      },
      "*"
    );
  }, []);
  ...
  return (
    <Layout
      ...
      description="Browse reviewed, SHA-pinned plugins for Athena Agent"
    >
          ...
          {!data && !loadError ? (
            ...
            <div className={styles.empty}>
              ...
              <p className={styles.emptyDesc}>
                The plugin catalog is a curated, human-reviewed list of Athena
