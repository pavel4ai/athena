    ...
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          ...
          describes how they use Athena &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Athena?{' '}
        <a
          href="https://github.com/pavel4ai/athena/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://futurebnd.com" target="_blank" rel="noopener noreferrer">
          Futurebound Corp. Discord
        </a>{' '}
