...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `athena_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `athena_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Athena Plugin](plugins/index.md) |
...
| Session storage | `athena_state.py`, `athena_state_*.py` | [Session Storage](session-storage.md) |
