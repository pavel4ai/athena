...
2. **Plugin tools** — `athena_cli.plugins.discover_plugins()` loads user/project/pip plugins that may register additional tools.
...
- platform presets (`athena-cli`, `athena-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `athena-acp`
