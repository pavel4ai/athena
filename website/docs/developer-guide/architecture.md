...
├── cli.py                    # AthenaCLI facade — mixins in athena_cli/cli_*_mixin.py
├── model_tools.py            # Tool discovery, schema collection, dispatch
├── toolsets.py               # Tool groupings and platform presets
├── athena_state.py           # SQLite session/state database facade (+ athena_state_*.py siblings)
...
│   ├── main.py               # Entry point — `athena` subcommands (parsers in subcommands/, main_*.py)
