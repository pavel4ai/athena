...
athena acp --bootstrap      # print install snippet for an ACP-capable IDE
```
...
Every command in the Pi-mono RPC spec ([issue #360](https://github.com/pavel4ai/athena/issues/360)) has a TUI-gateway equivalent:
