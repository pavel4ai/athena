...
2. **context** — caller-supplied `system_message` plus project context files (`.athena.md` / `AGENTS.md` / `CLAUDE.md` / `.cursorrules`)
...
You are Athena, an AI assistant created by Futurebound Corp..
