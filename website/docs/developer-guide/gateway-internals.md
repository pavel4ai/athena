...
- **Explicit target delivery** — `send_message` tool specifying `telegram:-1001234567890`, or the [`athena send` CLI](/guides/pipe-script-output) wrapping the same tool for shell scripts
