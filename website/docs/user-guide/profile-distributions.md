...
- **You just want to back up a profile on your own machine.** Use [`athena profile export` / `import`](../reference/profile-commands.md#athena-profile-export) — that's what those are for.
...
- [`athena profile export` / `import`](../reference/profile-commands.md#athena-profile-export) — local backup / restore (not distribution)
