...
| Related skills | [`codex`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`athena-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-athena-agent) |
...
```bash
TASK_ID="${ATHENA_KANBAN_TASK:-t_manual}"
REPO="/path/to/repo"
