...
Set your Tenor API key in your environment (add to `${ATHENA_HOME:-~/.athena}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/pavel4ai/athena/blob/main/skills/media/gif-search/url)`
