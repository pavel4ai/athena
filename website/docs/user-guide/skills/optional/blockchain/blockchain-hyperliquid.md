...
| | |
|---|---|
| Source | Optional — install with `athena skills install official/blockchain/hyperliquid` |
...
The script reads `${ATHENA_HOME:-~/.athena}/.env` for two optional defaults:
...
Helper script: `~/.athena/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.athena/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${ATHENA_HOME:-~/.athena}/.env`.
...
```bash
python3 ~/.athena/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.athena/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
