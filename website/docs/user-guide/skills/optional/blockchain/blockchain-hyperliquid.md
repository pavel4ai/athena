...
```bash
python ~/.athena/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.athena/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.athena/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
