...
| | |
|---|---|
| Source | Optional — install with `athena skills install official/blockchain/evm` |
...
Helper script path: `~/.athena/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.athena/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.athena/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.athena/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
