...
| | |
|---|---|
| Source | Optional — install with `athena skills install official/research/osint-investigation` |
...
# $ATHENA_OSINT_CACHE/icij/ (default: ~/.cache/athena-osint/icij/).
...
# Set ATHENA_OSINT_UA=your-app/1.0 (your@email) to identify yourself
