...
| | |
|---|---|
| Source | Optional — install with `athena skills install official/research/darwinian-evolver` |
...
Open `~/.athena/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Athena core.
   Custom driver scripts under `~/.athena/skills/...` are user-side and fine.
