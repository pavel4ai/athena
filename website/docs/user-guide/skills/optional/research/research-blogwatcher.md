...
| | |
|---|---|
| Source | Optional — install with `athena skills install official/research/blogwatcher` |
...
## Working with Athena tools (read this first)

`blogwatcher-cli` is the feed database; Athena tools do the automation around it:
