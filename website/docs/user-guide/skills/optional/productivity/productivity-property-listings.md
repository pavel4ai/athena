...
| | |
|---|---|
| Source | Optional — install with `athena skills install official/productivity/property-listings` |
...
Present researched properties as browsable cards in the Athena desktop transcript.
...
- A Athena desktop conversation for native cards; the backend may be local or remote.
...
```text
athena skills install official/productivity/property-listings
```
