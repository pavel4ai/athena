...
| | |
|---|---|
| Source | Optional — install with `athena skills install official/finance/stocks` |
...
```
SCRIPT=~/.athena/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.athena/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
