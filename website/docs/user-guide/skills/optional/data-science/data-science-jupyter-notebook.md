...
| | |
|---|---|
| Source | Optional — install with `athena skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing athena tool access (web_search, file ops). Stateless. |
