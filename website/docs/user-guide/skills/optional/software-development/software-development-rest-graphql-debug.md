...
| | |
|---|---|
| Source | Optional — install with `athena skills install official/software-development/rest-graphql-debug` |
...
- Never hardcode tokens in scripts. Read from env (`os.environ["API_TOKEN"]`) or `${ATHENA_HOME:-~/.athena}/.env`.
