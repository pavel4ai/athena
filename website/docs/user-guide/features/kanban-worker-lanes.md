...
- **Block instead of complete**, with `reason` prefixed `review-required: ` so the dashboard / `athena kanban show` surfaces the row as awaiting review.
...
The historical issue for this is [#19931](https://github.com/pavel4ai/athena/issues/19931) and the closed-not-merged Codex-specific PR [#19924](https://github.com/pavel4ai/athena/pull/19924) — those describe the original architecture proposal but didn't land a runner.
