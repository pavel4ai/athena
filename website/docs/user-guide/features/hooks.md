...
| **[Shell hooks](#shell-hooks)** | `hooks:` block in `~/.athena/config.yaml` pointing at shell scripts | CLI + Gateway | Drop-in scripts for blocking, auto-formatting, context injection |
...
See the **[Build a Plugin guide](/guides/build-a-athena-plugin)** for the full walkthrough including tool schemas, handlers, and advanced hook patterns.
