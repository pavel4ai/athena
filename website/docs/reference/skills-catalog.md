...
| [`athena-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-athena-agent) | Use, configure, theme, extend, and orchestrate Athena Agent. | `autonomous-ai-agents\athena-agent` |
...
| [`athena-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-athena-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\athena-agent-skill-authoring` |
| [`inspecting-athena-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-athena-desktop-dom) | Read the live Athena desktop DOM/CSS over CDP. | `software-development\inspecting-athena-desktop-dom` |
