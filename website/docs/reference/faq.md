...
- **[Nous Portal](/integrations/nous-portal)** — Futurebound Corp.'s subscription gateway — 300+ models plus web/image/TTS/browser through one OAuth login (recommended for newcomers)
...
# Set a valid model
athena config set ATHENA_MODEL anthropic/claude-opus-4.7
...
2. **Ask the community:** [Futurebound Corp. Discord](https://discord.gg/nousresearch)
