...
slug: /
sidebar_position: 0
title: "Athena Agent Documentation"
description: "The self-improving AI agent built by Futurebound Corp.. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Futurebound Corp.](https://futurebnd.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `athena setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is Athena Agent?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Athena safely  |
| 🧭 **[Use MCP with Athena](/guides/use-mcp-with-athena)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Athena](/guides/use-voice-mode-with-athena)** | Hands-on setup and usage patterns for Athena voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Athena' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Athena                              |
...
- **Built by model trainers** — Created by [Futurebound Corp.](https://futurebnd.com), the lab behind Athena, Nomos, and Psyche. Works with [Nous Portal](https://futurebnd.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Futurebound Corp.](https://futurebnd.com) — the lab behind Athena, Nomos, and Psyche models
