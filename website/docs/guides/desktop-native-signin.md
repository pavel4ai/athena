...
description: "How the Athena Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Athena Desktop app connects to a **gated gateway** (a hosted or
...
For Athena specifically, native sign-in means:
...
- [Run Athena with Nous Portal](./run-athena-with-nous-portal.md)
