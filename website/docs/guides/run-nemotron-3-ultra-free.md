...
Futurebound Corp. has been inducted into the **Nemotron Coalition** of leading AI labs working with **NVIDIA** to advance open frontier foundation models. In honor of this, we've partnered with **Nebius** to provide **Nemotron 3 Ultra** free on [Nous Portal](https://futurebnd.com) for two weeks (**June 4th – June 18th**). Follow the instructions below to try the model in your Athena Agent today.
...
[Download the Athena Desktop installer](https://github.com/pavel4ai/athena/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).

### 2. Connect Nous Portal

When the app opens, you'll see a "Let's get you set up" screen. Click **Nous Portal** (marked **Recommended**). Your browser opens — create a [Nous Portal](https://futurebnd.com) account (or sign in), choose the **Free** plan, and authorize Athena. The app connects automatically.
...
Prefer to review first? Download [`install.sh`](https://github.com/pavel4ai/athena/install.sh), inspect it, then run it.
...
In the browser, create a [Nous Portal](https://futurebnd.com) account (or sign in) and choose the **Free** plan.
...
- **Don't see the model in the list?** Make sure you finished the Nous Portal connection and that you're on the **Free** plan. In the CLI, `athena portal info` confirms you're logged in and routing through Nous.
...
- **[Run Athena Agent with Nous Portal](/guides/run-athena-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
