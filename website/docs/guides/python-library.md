...
```bash
pip install git+https://github.com/pavel4ai/athena.git
```

Or with [uv](https://docs.astral.sh/uv/):

```bash
uv pip install git+https://github.com/pavel4ai/athena.git
```

You can also pin it in your `requirements.txt`:

```text
athena-agent @ git+https://github.com/pavel4ai/athena.git
```
