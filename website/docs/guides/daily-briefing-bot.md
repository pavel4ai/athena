...
:::tip
This recipe hits web search, summarization, and optional TTS — all bundled in a Portal subscription. The fastest setup is `athena setup --portal`. See [Nous Portal](/integrations/nous-portal).
:::
...
You can still follow this tutorial using `deliver: "local"`. Briefings will be saved to `~/.athena/cron/output/` and you can read them anytime.
:::
