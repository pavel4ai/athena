...
For how to ship skills in your own plugin, see [Build a Athena Plugin → Bundle skills](/developer-guide/plugins#bundle-skills).
...
athena config get skills.config --json
```
