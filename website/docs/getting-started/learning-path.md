...
First-time users almost always want `athena setup --portal` — one OAuth covers a model plus the four Tool Gateway tools (search/image/TTS/browser). See [Nous Portal](/integrations/nous-portal).
:::
...
7. [Use Voice Mode with Athena](/guides/use-voice-mode-with-athena)
...
2. [Build a Athena Plugin](/guides/build-a-athena-plugin)
...
Use reinforcement learning to fine-tune model behavior with Athena Agent's RL training pipeline (powered by [Atropos](https://github.com/FutureboundCorp/atropos)).

1. [Quickstart](/getting-started/quickstart)
2. [Configuration](/user-guide/configuration)
3. [Atropos RL Environments](https://github.com/FutureboundCorp/atropos) (external)
