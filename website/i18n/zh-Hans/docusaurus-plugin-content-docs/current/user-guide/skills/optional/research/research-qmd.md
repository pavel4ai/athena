...
| | |
|---|---|
| 来源 | 可选 — 通过 `athena skills install official/research/qmd` 安装 |
...
| 相关 skill | [`obsidian`](/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`athena-agent`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-athena-agent), [`arxiv`](/user-guide/skills/bundled/research/research-arxiv) |
