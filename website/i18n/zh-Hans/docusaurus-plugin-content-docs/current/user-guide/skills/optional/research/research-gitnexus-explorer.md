...
| | |
|---|---|
| 来源 | 可选 — 使用 `athena skills install official/research/gitnexus-explorer` 安装 |
...
| 相关 skill | [`athena-agent`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-athena-agent), [`codebase-inspection`](/user-guide/skills/bundled/github/github-codebase-inspection) |
