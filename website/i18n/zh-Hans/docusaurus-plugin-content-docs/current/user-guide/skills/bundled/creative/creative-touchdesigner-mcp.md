...
| 相关 skill | [`native-mcp`](/user-guide/skills/bundled/mcp/mcp-native-mcp), [`ascii-video`](/user-guide/skills/bundled/creative/creative-ascii-video), [`manim-video`](/user-guide/skills/bundled/creative/creative-manim-video), `athena-video` |
...
```bash
bash "${ATHENA_HOME:-$HOME/.athena}/skills/creative/touchdesigner-mcp/scripts/setup.sh"
```
