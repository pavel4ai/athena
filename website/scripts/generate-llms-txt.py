...
Both publish at:
  https://github.com/pavel4ai/athena/docs/llms.txt
  https://github.com/pavel4ai/athena/docs/llms-full.txt
...
SITE_BASE = "https://github.com/pavel4ai/athena/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/use-mcp-with-athena", "Use MCP with Athena", None),
        ("guides/use-voice-mode-with-athena", "Use Voice Mode with Athena", None),
        ("guides/use-soul-with-athena", "Use SOUL.md with Athena", None),
        ("guides/build-a-athena-plugin", "Build a Athena Plugin", None),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Futurebound Corp.. A terminal-native "
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/FutureboundCorp/"
        "athena-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/pavel4ai/athena")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://github.com/pavel4ai/athena/docs\n",
        "Short index: https://github.com/pavel4ai/athena/docs/llms.txt\n",
        "\n---\n\n",
    ]
