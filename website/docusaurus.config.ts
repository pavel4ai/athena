...
const config: Config = {
  ...
  url: 'https://github.com/pavel4ai/athena',
  baseUrl: '/docs/',

  organizationName: 'FutureboundCorp',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/pavel4ai/athena/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/pavel4ai/athena/',
          label: 'Download',
          position: 'left',
        },
        {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://futurebnd.com' },
            { label: 'GitHub Issues', href: 'https://github.com/pavel4ai/athena/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://github.com/pavel4ai/athena/' },
            { label: 'GitHub', href: 'https://github.com/pavel4ai/athena' },
            { label: 'Futurebound Corp.', href: 'https://futurebnd.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://futurebnd.com">Futurebound Corp.</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
