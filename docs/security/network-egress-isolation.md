...
#
# Usage:
#   ATHENA_UID=$(id -u) ATHENA_GID=$(id -g) docker compose up -d
#
...
services:
  gateway:
    ...
    environment:
      ...
      - NO_PROXY=athena,athena-dashboard,localhost
...
docker compose exec gateway \
  curl -sf --max-time 5 http://athena-dashboard:9119/health && echo "OK: internal reachable" || echo "FAIL"
