...
def _in_delegated_child_context() -> bool:
    ...
    threads and inherit process-wide ``ATHENA_INTERACTIVE=1``, which does NOT mean they can reach
...
def _transform_sudo_command(
    ...
    # delegate_task children inherit ATHENA_INTERACTIVE=1 (and possibly a stale thread-local
    ...
    should_prompt_for_sudo = (
        env_var_enabled("ATHENA_INTERACTIVE") or _get_sudo_password_callback() is not None
