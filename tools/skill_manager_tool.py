...
~/.athena/skills/. Existing skills (bundled, hub-installed, or user-created)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.athena/skills/) first, then any
...
def _find_skill_in_other_profiles(name: str) -> List[Tuple[str, Path]]:
    ...
    # Default profile (~/.athena/skills) — only consider when active is non-default.
    ...
    # All named profiles (~/.athena/profiles/*/skills)
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        f"New skills go to {display_athena_home()}/skills/; existing skills can be modified wherever they live.\n\n"
