...
`hey_athena.onnx` / `hey_athena.tflite` — the on-device "Hey Athena" hotword
...
- **Label:** the model registers as `hey_athena` (matches the filename).
