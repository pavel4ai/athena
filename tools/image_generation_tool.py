...
def check_image_generation_requirements() -> bool:
    ...
    the historical behavior: shipping athena with a FAL key configured
        ...
        if "image_url" in kwargs or "reference_image_urls" in kwargs:
            ...
            return json.dumps({
                ...
                "error": (
                    ...
                    f"supports editing via `athena tools` → Image Generation."
                ),
...
# model/provider via `athena tools` or `/skills`.
