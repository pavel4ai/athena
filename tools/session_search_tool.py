...
the get_anchored_view / get_messages_around primitives in athena_state.
...
# Third-party integrations tag their sessions with ATHENA_SESSION_SOURCE=tool;
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches Athena conversation history only. It is not evidence "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about Athena conversation history itself, such "
