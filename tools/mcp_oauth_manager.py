...
`mcp_tool.py`, and `athena_cli/mcp_config.py`. This module is the ONLY place
...
def _make_athena_provider_class() -> Optional[type]:
                ...
                for url in build_protected_resource_metadata_discovery_urls(
                    ...
                    try:
                        ...
                        logger.debug(
                            ...
                            self._athena_server_name, url, exc,
                        )
                        continue
...
_ATHENA_PROVIDER_CLS: Optional[type] = _make_athena_provider_class()
    ...
    def _build_provider(
        ...
        if not _is_interactive() and not storage.has_cached_tokens():
            raise OAuthNonInteractiveError(
                ...
                "cached tokens found. Run `athena mcp login "
