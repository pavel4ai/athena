      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via ATHENA_BUNDLED_SKILLS /
            # ATHENA_OPTIONAL_SKILLS (see athena-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + ATHENA_BUNDLED_LOCALES
            # / ATHENA_OPTIONAL_MCPS, not via the wheel. Excluding them
