...
def step(mode):
    from athena_cli.main_dashboard import _install_hangup_protection, _finalize_update_output
    from athena_cli.main import _run_logged_subprocess
