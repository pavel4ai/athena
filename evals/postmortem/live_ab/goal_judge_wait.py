...
os.environ.setdefault("ATHENA_HOME", os.path.expanduser("~/.athena"))  # LIVE: real auxiliary judge calls (cents)
from athena_cli import goals
goal = ("Simplify the athena-agent codebase by >=30% LOC with zero behavior change, decomposing every god file, "
