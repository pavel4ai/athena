...
os.environ["ATHENA_HOME"] = str(root / ".athena")
from athena_cli import update_cmd_fleet as fleet, update_receipt as receipts
...
try:
    for name in ["alpha", "beta"]:
        home = root / ".athena" / "profiles" / name
    ...
    d = root / ".athena/logs/update_receipts"
    ...
    home = root / ".athena/profiles/beta"
