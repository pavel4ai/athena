...
The run gets a throwaway ATHENA_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE ATHENA_HOME is redirected to the
