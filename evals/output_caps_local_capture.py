...
Run from a checkout with ATHENA_HOME pointing to a disposable directory.
"""
import json
import os
...
os.environ["ATHENA_MAX_TOKENS"] = "13"
...
from athena_cli.moa_config import _normalize_preset
