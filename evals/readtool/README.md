...
benchmarked ten harnesses on hostile-file handling — and whose Athena column
...
Every task runs the full Athena agent (file + terminal + search toolsets)
...
Rules of engagement (from athenabench discipline):
