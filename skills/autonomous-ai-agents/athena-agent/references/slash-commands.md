...
Registry of record: `athena_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Athena config+state snapshots (CLI)
...
/update                  Update Athena to latest
