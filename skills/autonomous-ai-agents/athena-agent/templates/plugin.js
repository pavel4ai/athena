/**
 * Athena desktop plugin template. Save as:
 *   <athena home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <athena home> is ~/.athena by default, or ~/.athena/profiles/<name>
 * when running a named profile (`athena -p <name>`). Run `athena doctor` (or
 ...
 * Only these imports resolve: @athena/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@athena/plugin-sdk'
