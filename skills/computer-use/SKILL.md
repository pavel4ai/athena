...
for the platform plumbing. The Athena-side `computer_use` tool exposed
in this skill is a higher-level Athena vocabulary; the raw cua-driver
...
When `cua-driver skills install` autodetects Athena (planned follow-up
