...
Built for [Athena Agent](https://github.com/pavel4ai/athena). Usable in any coding agent. Canonical source lives here; synced to [`pavel4ai/athena/skills/creative/ascii-video`](https://github.com/pavel4ai/athena/tree/main/skills/creative/ascii-video) via PR.
