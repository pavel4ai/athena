...
Athena equivalent — works today:
```bash
athena webhook subscribe auth-watch \
  --events "pull_request" \
...
```bash
athena gateway setup    # enable webhooks
athena webhook subscribe pr-review \
  --events "pull_request" \
...
Full automation blueprints gallery: [futurebnd.com/docs/reference/automation-blueprints-catalog](https://github.com/pavel4ai/athena/docs/reference/automation-blueprints-catalog)

Documentation: [futurebnd.com](https://github.com/pavel4ai/athena)

GitHub: [github.com/pavel4ai/athena](https://github.com/pavel4ai/athena)

---

*Athena Agent is built by [Futurebound Corp.](https://futurebnd.com). Open source, model-agnostic, runs on your infrastructure.*
