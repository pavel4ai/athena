...
class SessionManager:
    ...
    def __init__(self, agent_factory=None, db=None):
        ...
        Args:
            ...
            db:            Optional SessionDB instance. When omitted, the default
                           SessionDB (``~/.athena/state.db``) is lazily created.
        """
    ...
    def _get_db(self):
        ...
        Note: we resolve ``ATHENA_HOME`` dynamically rather than relying on
        ...
        later (e.g. by the test fixture ``_isolate_athena_home``).
        """
        ...
        try:
            ...
            self._db_instance = SessionDB(db_path=athena_home / "state.db")
            return self._db_instance
        except Exception:
    ...
    def _make_agent(
        ...
        *,
        ...
        # editor/session cwd instead of the Athena daemon's process cwd.
