...
- athena chat          - Interactive chat (same as ./athena)
- athena gateway       - Run gateway in foreground
- athena gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    athena_cli/stdio.py::configure_windows_stdio() runs later from the entry
