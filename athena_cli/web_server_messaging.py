...
from athena_cli.config import OPTIONAL_ENV_VARS, write_platform_config_field
...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    "telegram": {
        "name": "Telegram", "description": "Run Athena from Telegram DMs, groups, and topics.",
        "docs_url": "https://core.telegram.org/bots/features#botfather",
        "env_vars": ("TELEGRAM_BOT_TOKEN", "TELEGRAM_ALLOWED_USERS", "TELEGRAM_PROXY"),
        "required_env": ("TELEGRAM_BOT_TOKEN",),
    },
    "discord": {
        "name": "Discord", "description": "Connect Athena to Discord DMs, channels, and threads.",
    ...
    "matrix": {
        "name": "Matrix", "description": "Use Athena in Matrix rooms and direct messages.",
    ...
    "email": {
        "name": "Email", "description": "Talk to Athena through an IMAP/SMTP mailbox.",
    ...
    "dingtalk": {
        "name": "DingTalk", "description": "Connect Athena to DingTalk groups (钉钉).",
        "docs_url": "https://open.dingtalk.com/document/orgapp/the-robot-development-process",
        "env_vars": ("DINGTALK_CLIENT_ID", "DINGTALK_CLIENT_SECRET"),
        "required_env": ("DINGTALK_CLIENT_ID", "DINGTALK_CLIENT_SECRET"),
    },
    "feishu": {
        "name": "Feishu / Lark", "description": "Use Athena inside Feishu / Lark.",
    ...
    "google_chat": {
        "name": "Google Chat", "description": "Connect Athena to Google Chat via Cloud Pub/Sub.",
        "docs_url": "https://athena-agent.nousresearch.com/docs/user-guide/messaging/google_chat",
    },
    "wecom": {
    ...
    "weixin": {
        ...
        "docs_url": "https://athena-agent.nousresearch.com/docs/user-guide/messaging/weixin/",
    ...
    "qqbot": {
        "name": "QQ Bot", "description": "Connect Athena to a QQ Bot from the QQ Open Platform.",
    ...
    "teams": {
        "description": "Connect Athena to Microsoft Teams chats via the Bot Framework.",
        "docs_url": "https://athena-agent.nousresearch.com/docs/user-guide/messaging/teams",
    },
    ...
    "irc": {
        "description": "Relay messages between an IRC channel (or DMs) and Athena.",
        "docs_url": "https://athena-agent.nousresearch.com/docs/user-guide/messaging/irc",
    },
    "line": {
        "description": "Use Athena from LINE via the LINE Messaging API webhook.",
        "docs_url": "https://athena-agent.nousresearch.com/docs/user-guide/messaging/line",
    },
    "ntfy": {
        "description": "Chat with Athena over ntfy push topics (ntfy.sh or self-hosted).",
        "docs_url": "https://athena-agent.nousresearch.com/docs/user-guide/messaging/ntfy",
    },
    "photon": {
        "description": "Use Athena through iMessage via Photon's managed Spectrum platform.",
        "docs_url": "https://athena-agent.nousresearch.com/docs/user-guide/messaging/photon",
    },
    "raft": {
        "description": "Join a Raft workspace as an external agent.",
        "docs_url": "https://athena-agent.nousresearch.com/docs/user-guide/messaging/raft",
    },
    "simplex": {
        "description": "Talk to Athena over SimpleX Chat via a local simplex-chat daemon.",
        "docs_url": "https://athena-agent.nousresearch.com/docs/user-guide/messaging/simplex",
    },
    "yuanbao": {
        "name": "Yuanbao (元宝)", "description": "Connect Athena to Tencent Yuanbao.", "docs_url": "",
        "required_env": (),
    },
    "api_server": {
        "name": "API server",
    ...
    "msgraph_webhook": {
        ...
        "docs_url": "https://athena-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook",
        "required_env": (),
    },
    "whatsapp_cloud": {
        "name": "WhatsApp Cloud API",
        "description": "Use Athena via Meta's hosted WhatsApp Cloud API (no local bridge).",
        "docs_url": "https://athena-agent.nousresearch.com/docs/user-guide/messaging/whatsapp-cloud",
    },
    "relay": {
        "name": "Relay (experimental)",
        "description": "Generic relay adapter fronted by the Athena Relay connector.",
...
def _whatsapp_session_path() -> Path:
    ...
    return get_athena_dir("platforms/whatsapp/session", "whatsapp/session")
...
def _restart_gateway_after_whatsapp_onboarding(profile: Optional[str] = None) -> dict[str, Any]:
    from athena_cli.web_server_gateway import _restart_gateway_after
