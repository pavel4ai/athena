...
Skins are defined as YAML files in ~/.athena/skins/ or as built-in presets.
...
.. code-block:: python
    ...
    from athena_cli.skin_engine import get_active_skin, list_skins, set_active_skin
    ...
    set_active_skin("mytheme")            # Switch to user skin from ~/.athena/skins/
...
Drop a YAML file in ``~/.athena/skins/<name>.yaml`` following the schema above.
