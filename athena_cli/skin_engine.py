"""Athena skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ATHENA_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces ATHENA_CADUCEUS)
...
# Branding shared by every Athena-named built-in (mono/daylight override help_header).
_ATHENA_BRANDING: Dict[str, str] = _branding(
    "Athena", "⚕", "Goodbye! ⚕", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "Classic Athena — gold and kawaii",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_ATHENA_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _ATHENA_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
