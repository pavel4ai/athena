...
from athena_cli.banner import _format_context_length
...
class CLIStatusBarMixin:
    ...
    def _get_status_bar_snapshot(self) -> Dict[str, Any]:
        ...
        try:
            from athena_cli.focus_view import focus_statusbar_segment
    ...
    def _pet_resolve_config(self) -> None:
        """(Re)resolve the active pet from config so ``/pet`` / ``athena pets`` changes apply
