...
Invoked by ``athena kanban decompose [task_id | --all]`` and the gateway
...
from athena_cli.kanban_specify import (
    _call_aux, _extract_json_blob, _load_triage_task, _task_prompt_fields, _title_body,
)
from athena_cli.kanban_specify import _profile_author as _specify_author
...
def _profile_author() -> str:
    """Mirror of ``athena_cli.kanban._profile_author``."""
