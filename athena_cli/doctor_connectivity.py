"""API connectivity probes for ``athena doctor`` (split out of ``doctor.py``).
...
def _apikey_request(key: str, base_env, default_url) -> tuple:
    ...
    headers = {"Authorization": f"Bearer {key}", "User-Agent": _ATHENA_USER_AGENT}
