...
class CLICommandsMixin:
    ...
    def _handle_rollback_command(self, command: str):
        ...
        if not mgr.enabled:
            ...
            print("  Enable with: athena --checkpoints")
    ...
    def _handle_image_command(self, cmd_original: str):
        ...
        if _remainder:
            ...
            _cprint(f"  {_DIM}Tip: type your next message, or run athena chat -q --image {_termux_example_image_path(image_path.name)} \"What do you see?\"{_RST}")
    ...
    def _handle_tools_command(self, cmd: str):
        ...
        def _run_capture(ns: Namespace) -> None:
            ...
            # Buffer reports isatty()=True so color() in athena_cli/colors.py
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to athena_cli.curator so the CLI and the `athena curator`
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to athena_cli.skills_hub."""
    ...
    def _handle_bundles_command(self, cmd: str) -> None:
        ...
        if not bundles:
            ...
            _cprint(
                f"  {_DIM}Create one with: athena bundles create "
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        if len(parts) < 2 or not parts[1].strip():
            ...
            print("\n  Usage: /skin <name>")
            print(f"  Custom skins: drop a YAML file in {display_athena_home()}/skins/\n")
            return
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from athena_cli.models import _is_anthropic_fast_model
