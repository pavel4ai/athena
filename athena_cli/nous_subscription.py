...
# coverage category (athena_cli.nous_account.TOOL_COVERAGE_CATEGORIES). Lets the
    ...
    *,
    ...
    try:
        ...
        local_stt_available = bool(_HAS_FASTER_WHISPER) or bool(
            get_env_value("ATHENA_LOCAL_STT_COMMAND")
        )
    except Exception:
        local_stt_available = bool(get_env_value("ATHENA_LOCAL_STT_COMMAND"))
