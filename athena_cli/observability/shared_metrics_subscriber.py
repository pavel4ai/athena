"""Relay subscriber for the persisted Athena shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Athena counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Athena shared metric: %s", metric_name, exc_info=True
                )
