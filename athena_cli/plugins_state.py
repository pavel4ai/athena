"""Plugin-owned durable state and namespaced settings helpers (split out of athena_cli.plugins)."""
...
from athena_cli.plugins_manifest import _portable_skill_namespace
...
class PluginState:
    ...
    def data_dir(self) -> Path:
        ...
        return get_athena_home() / "plugin-data" / self._data_namespace
