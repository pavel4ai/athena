...
The actual runtime resolution happens in athena_cli.runtime_provider's
    ...
    *,
    ...
    if new_value == "codex_app_server":
        ...
        try:
            ...
            # Tools/MCP servers (excluding the athena-tools callback,
            # which is internal plumbing — surface separately).
            user_servers = [
                s for s in mig_report.migrated if s != "athena-tools"
            ]
            if user_servers:
                msg_lines.append(
