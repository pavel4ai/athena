...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Athena to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Athena needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Athena gateway in another terminal:",
        "         athena gateway", "",
    ...
    _lines(
        ...
        "  Docs: https://athena-agent.nousresearch.com/docs/user-guide/",
