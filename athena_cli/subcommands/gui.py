...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Athena Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any athena CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--athena-root",
        help="Override the Athena source root used by Desktop (sets ATHENA_DESKTOP_ATHENA_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets ATHENA_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Athena Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Athena Local Signing)",
    )
