...
def build_dashboard_parser(
    ...
    dashboard_parser.add_argument(
        "--stop",
        action="store_true",
        help="Stop all running athena dashboard processes and exit",
    )
    dashboard_parser.add_argument(
        "--status",
        action="store_true",
        help="List running athena dashboard processes and exit",
    )
    ...
    # client with Nous Portal and write the client_id into ~/.athena/.env.
