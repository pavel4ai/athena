...
def build_claw_parser(subparsers, *, cmd_claw: Callable) -> None:
    ...
    claw_migrate = claw_subparsers.add_parser(
        "migrate", help="Migrate from OpenClaw to Athena",
    ...
    claw_migrate.add_argument(
        ...
        help="Skip the pre-migration zip snapshot of ~/.athena/ (by default a "
        "single restore-point archive is written to ~/.athena/backups/ "
        "before apply; restorable with 'athena import').")
    claw_migrate.add_argument(
