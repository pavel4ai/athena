...
def build_plugins_parser(subparsers, *, cmd_plugins: Callable) -> None:
    ...
    plugins_parser = subparsers.add_parser(
        ...
        description="Install, update, remove, list, or validate native Athena plugins "
    ...
    plugins_install.add_argument(
        "identifier",
        help="Bare plugin catalog entry name (see `athena plugins search`), Git URL, or owner/repo "
            "shorthand (e.g. anpicasso/athena-plugin-chrome-profiles)")
    plugins_install.add_argument(
    ...
    plugins_search = plugins_subparsers.add_parser(
        "search", help="Search the curated Athena plugin catalog")
    ...
    plugins_pack = plugins_subparsers.add_parser(
        "pack", help="Declarative, shareable plugin sets (athena-pack.yaml)",
    ...
    pack_install.add_argument("source", help="Path to a athena-pack.yaml file, or an https:// URL")
    ...
    pack_export.add_argument(
        "--name", default="my-athena-pack", help="Pack name to embed in the exported YAML")

    pack_show = pack_subparsers.add_parser(
        "show", help="Dry-run: parse and display a pack without installing")
    pack_show.add_argument("source", help="Path to a athena-pack.yaml file, or an https:// URL")
