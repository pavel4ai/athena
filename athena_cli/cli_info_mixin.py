...
Mixin split out of ``cli.py``; bound onto ``AthenaCLI`` via the MRO. cli.py-internal symbols are
...
from athena_cli.cli_modal_mixin import _gated_confirm
...
class CLIInfoMixin:
    ...
    def show_banner(self):
        ...
        if is_nous_athena_non_agentic(getattr(self, "model", "") or ""):
            self._console_print()
            self._console_print(
        ...
        # `athena skills trust`. Never raises.
        try:
            ...
            if _proj_dirs:
                ...
                if _untrusted is not None:
                    ...
                    self._console_print(
                        ...
                        f"loaded — run `athena skills trust` to enable them.[/]")
        except Exception:
    ...
    def show_help(self, arg: str = ""):
        ...
        from athena_cli.commands import COMMANDS_BY_CATEGORY, HELP_SESSION_SUBGROUPS
    ...
    def handle_bang_shell(self, text: str) -> bool:
        ...
        from athena_cli.bang_shell import (
    ...
    def _toggle_verbose(self):
        ...
        if getattr(self, "_focus_view_enabled", False):
            ...
            try:
                from athena_cli.focus_view import FOCUS_CONFIG_KEY
    ...
    def _usage_reset(self, force: bool = False):
        ...
        if str(self._agent_or_self("provider") or "").strip().lower() != "openai-codex":
            ...
            print("  Switch with `/model` or `athena auth` first.")
            return
    ...
    def _reload_skills(self) -> None:
        """Reload skills: rescan ~/.athena/skills/ and queue a note for the next user turn.
