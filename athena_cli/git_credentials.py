"""Non-interactive HTTPS credentials for Athena's internal git clones (private plugin/MCP/profile repos).
...
repo the user can already clone from their shell fails inside ``athena plugins install`` with
