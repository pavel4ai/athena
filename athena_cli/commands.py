"""Slash command registry for the Athena CLI and gateway.
...
from athena_constants import INDICATOR_STYLES
...
class CommandDef:
    ...
    # Key in ``athena_cli.slash_exec.EXECUTORS`` (a string, not a callable: keeps this module
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("plan", "Write a markdown implementation plan to .athena/plans/ without executing anything", "Session",
               args_hint="[task]"),
    ...
    CommandDef("wake", "Toggle the 'Hey Athena' wake word listener", "Configuration",
               cli_only=True, args_hint="[on|off|status]", subcommands=("on", "off", "status")),
    CommandDef("busy", "Control how messages behave while Athena is working", "Configuration",
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'discord_skill_commands_by_category': ('athena_cli.commands_platforms', 'discord_skill_commands_by_category'),
    'slack_app_manifest': ('athena_cli.commands_platforms', 'slack_app_manifest'),
    'slack_native_slashes': ('athena_cli.commands_platforms', 'slack_native_slashes'),
    'slack_subcommand_map': ('athena_cli.commands_platforms', 'slack_subcommand_map'),
    'telegram_bot_commands': ('athena_cli.commands_platforms', 'telegram_bot_commands'),
    'telegram_menu_commands': ('athena_cli.commands_platforms', 'telegram_menu_commands'),
    'telegram_menu_max_commands': ('athena_cli.commands_platforms', 'telegram_menu_max_commands'),
}
