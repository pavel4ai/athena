...
OBSERVER_SCHEMA_VERSION = "athena.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "athena.middleware.v1"
...
def _invoke_middleware(kind: str, **kwargs: Any) -> List[Any]:
    from athena_cli.plugins import invoke_middleware

    return invoke_middleware(kind, **middleware_payload(**kwargs))


def _has_middleware(kind: str) -> bool:
    from athena_cli.plugins import has_middleware
