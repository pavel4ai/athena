...
* This module intentionally mirrors ``athena_cli/goals.py`` — same aux
...
ATHENA_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    env_int("ATHENA_KANBAN_SPECIFY_MAX_TOKENS", 6000),
)
    ...
    *,
    ...
    try:
        resp = client.chat.completions.create(
            ...
            temperature=0.3,
            max_tokens=ATHENA_KANBAN_SPECIFY_MAX_TOKENS,
