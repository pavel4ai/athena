...
VERSION_FILE = REPO_ROOT / "athena_cli" / "__init__.py"
...
LEGACY_AUTHOR_MAP = {
    ...
    "pi@athena.local": "Elektrofussel",  # PR #61675 salvage (honcho: defaultHost + private-range local URL detection)
    ...
    "kavi@local.athena": "kavioavio",  # Issue #46544 / PR #47705 evolution (smart DENY exact-operation owner override)
    ...
    "sunsky.lau@gmail.com": "liuhao1024",  # PR #56993 salvage (gateway: process-level ATHENA_HOME for pid/lock/status identity files; #56986)
    ...
    "wyuebei@gmail.com": "wyuebei-cloud",  # PR #56640 salvage (athena journey: replace GNU-only %-d strftime with dt.day for Windows)
    ...
    "athena.wanderer@yahoo.com": "trismegistus-wanderer",  # PR #31856 salvage (gateway: defer idle-TTL agent-cache eviction until the session store says the session actually expired, so the expiry watcher can still fire MemoryProvider.on_session_end with the live transcript; #11205)
    ...
    "me@keslerm.com": "keslerm",  # PR #3459 salvage (gateway: 'log' tool_progress mode — silent in chat, tool calls appended to ~/.athena/logs/tool_calls.log via rotating handler; duplicate of #3458 by @dlkakbs who submitted 4 min earlier — both credited)
    ...
    "121278003+Cossackx@users.noreply.github.com": "Cossackx",  # PR #52528 salvage (Windows athena-shim resolution + prefer --update on recovery; #52378)
    ...
    "athena@marian.local": "Schrotti77",
    ...
    "athena@nousresearch.com": "NousResearch",
    ...
    "sberan@gmail.com": "sberan",  # PR #54494 salvage (--connect-timeout flag on athena mcp add)
    ...
    "athena@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "github@nadyaathena.anonaddy.com": "ruangraung",  # PR #42308
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (ATHENA_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (ATHENA_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: athena-eval community link)
    ...
    "athenaagent26@gmail.com": "athenaagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+athenaagent26@users.noreply.github.com": "athenaagent26",
    ...
    "vigo@athena": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.athena@agentmail.to": "oseftg",
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level ATHENA_HOME state files)
    ...
    "zhchl@athena-agent.local": "8294",  # PR #50572 salvage (honor config context_length on banner)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Keep the bootstrap installer (Athena-Setup.dmg CFBundleShortVersionString)
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "athena@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/pavel4ai/athena",
...
def main():
    ...
    print(f"{'='*60}")
    print("  Athena Agent Release Preview")
    print(f"{'='*60}")
