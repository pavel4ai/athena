...
IGNORED_PATTERNS = [
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (athena-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "athena@nousresearch.com",
    "athena-audit@example.com",
    "nousbot@nousresearch.com",
    "athena@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
