...
def main() -> None:
    ...
    athena_home = Path(tempfile.mkdtemp(prefix="athena-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "athena-gateway-smoke",
    ...
    print(json.dumps({"athena_home": str(athena_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
