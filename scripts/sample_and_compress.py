...
DEFAULT_DATASETS = [
    "FutureboundCorp/swe-terminus-agent-glm-kimi-minimax",
    "pavel4ai/athena-megascience-sft1",
    "pavel4ai/athena-Thinking-GLM-4.7-SFT2",
    "pavel4ai/athena-Thinking-GLM-4.7-SFT1",
    "FutureboundCorp/terminal-tasks-glm-athena-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "FutureboundCorp/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload FutureboundCorp/{output_name} {final_output}")
