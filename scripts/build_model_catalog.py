...
# Ensure ATHENA_HOME is set for imports that touch it at module level.
os.environ.setdefault("ATHENA_HOME", os.path.join(os.path.expanduser("~"), ".athena"))

from athena_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            ...
            "docs": "https://github.com/pavel4ai/athena/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
