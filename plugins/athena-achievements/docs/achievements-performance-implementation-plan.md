...
- Snapshot persisted at `~/.athena/plugins/athena-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.athena/plugins/athena-achievements/scan_checkpoint.json`.
