...
- persisted runtime files:
  - `~/.athena/plugins/athena-achievements/state.json` (existing unlock state)
  - `~/.athena/plugins/athena-achievements/scan_snapshot.json` (new)
  - `~/.athena/plugins/athena-achievements/scan_checkpoint.json` (new)
