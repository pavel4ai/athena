...
def qr_scan_for_bot_info(
    *,
    ...
    generate_url = f"{_QR_GENERATE_URL}?source=athena"
...
# wizard + _PLATFORMS["wecom"] static dict in athena_cli/gateway.py, and the
...
def interactive_setup() -> None:
    ...
    Replaces athena_cli/gateway.py::_setup_wecom and the static
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install 'athena-agent[wecom]'",
