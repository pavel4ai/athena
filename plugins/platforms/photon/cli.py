...
def _cmd_setup(args: argparse.Namespace) -> int:
    ...
    # 3. Rotate the project secret and persist creds (runtime -> ~/.athena/.env,
    ...
    print("  Start the gateway:  athena gateway start")
    return 0
...
def _telemetry_enabled() -> bool:
    """Read PHOTON_TELEMETRY from the env / ~/.athena/.env.
