...
and injects content-free wake hints into Athena' normal gateway session pipeline.
...
class RaftAdapter(BasePlatformAdapter):
    ...
    async def _handle_wake(self, request: "web.Request") -> "web.Response":
        ...
        # Athena only verifies that wake hints are content-free.
