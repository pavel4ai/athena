...
def _read_dm_role_auth_guild() -> Optional[int]:
    ...
    policy, ``~/.athena/.env`` is for secrets only, and this is a
...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reload-skills", description="Re-scan ~/.athena/skills/ for new or removed skills")
        ...
        # athena_cli/commands.py automatically appear as Discord slash
    ...
    def _refresh_skill_catalog_state(self) -> None:
        ...
        """
        from athena_cli.commands import discord_skill_commands_by_category
...
def _is_connected(config) -> bool:
    ...
    Looks up via ``athena_cli.gateway.get_env_value`` at call time (not via
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # athena_cli/setup.py::_setup_discord function.  Same shape as Teams.
