...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._text_batch_delay_seconds = self._env_float_clamped(
            "ATHENA_TELEGRAM_TEXT_BATCH_DELAY_SECONDS",
            0.3,
            min_value=0.08,
            max_value=2.0,
        )
        self._text_batch_split_delay_seconds = self._env_float_clamped(
            "ATHENA_TELEGRAM_TEXT_BATCH_SPLIT_DELAY_SECONDS",
            1.0,
    ...
    # older PTB/clients. Streaming edits stay on Athena' existing MarkdownV2
    ...
    def _has_telegram_desktop_details_math_crash_shape(self, content: str) -> bool:
        ...
        Athena must skip rich delivery up front and use the legacy MarkdownV2
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            request_kwargs = {
                "connection_pool_size": _env_int("ATHENA_TELEGRAM_HTTP_POOL_SIZE", 512),
                "pool_timeout": _env_float("ATHENA_TELEGRAM_HTTP_POOL_TIMEOUT", 8.0),
                "connect_timeout": _env_float("ATHENA_TELEGRAM_HTTP_CONNECT_TIMEOUT", 10.0),
                "read_timeout": _env_float("ATHENA_TELEGRAM_HTTP_READ_TIMEOUT", 20.0),
                "write_timeout": _env_float("ATHENA_TELEGRAM_HTTP_WRITE_TIMEOUT", 20.0),
            }
            ...
            try:
                ...
                from athena_cli.commands import telegram_menu_commands
    ...
    def _build_provider_keyboard(self, providers: list):
        ...
        """
        try:
            from athena_cli.models import group_providers
        except Exception:
    ...
    async def _handle_model_picker_callback(
        ...
        if data.startswith("mp:"):
            ...
            group_id = data[4:]
            try:
                from athena_cli.models import PROVIDER_GROUPS
    ...
    # Scripts live in ~/.athena/scripts/gmail-triage/. `arg` from the callback
    ...
    def _message_mentions_bot(self, message: Message) -> bool:
        ...
        # raw substring matches like "foo@athena_bot.example" are not mentions
...
# athena_cli/{setup,gateway}.py, and the _send_telegram dispatch in
...
def interactive_setup() -> None:
    ...
    _PLATFORMS["telegram"] static dict dispatch in athena_cli/gateway.py.
    """
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install 'athena-agent[telegram]'",
