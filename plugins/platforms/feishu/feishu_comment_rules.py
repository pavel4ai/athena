...
Config: ~/.athena/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.athena/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_athena_home()`` helper (ATHENA_HOME-aware and
