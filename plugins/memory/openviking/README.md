...
| `OPENVIKING_AGENT` | `athena` | Athena peer ID in OpenViking, used for peer-scoped memories |
...
file URIs, such as
`viking://user/peers/athena/memories/preferences/mem_abc123.md` or the canonical
`viking://user/default/peers/athena/memories/preferences/mem_abc123.md`. Files
