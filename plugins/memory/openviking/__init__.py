...
or a linked OpenViking CLI config:
  ...
  OPENVIKING_AGENT     — Athena peer ID in OpenViking (default: athena)
...
_DEFAULT_AGENT = "athena"
_AGENT_PROMPT_LABEL = "Athena peer ID in OpenViking"
...
def _openviking_server_log_path() -> Path:
    try:
        ...
        home = Path(os.environ.get("ATHENA_HOME", "")).expanduser() if os.environ.get("ATHENA_HOME") else Path.home() / ".athena"
...
class OpenVikingMemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        # against a concurrent increment. See athena-agent#28296 review.
    ...
    def get_config_schema(self):
        return [
            ...
            },
            {
                "key": "agent",
                "description": (
                    "Athena peer ID in OpenViking, sent as the actor peer and "
    ...
    def post_setup(self, athena_home: str, config: dict) -> None:
        ...
        athena_home_path = Path(athena_home)
        env_path = athena_home_path / ".env"
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        try:
            ...
            if health_state == "unreachable":
                ...
                _emit_runtime_warning(
                    f"{health_message} OpenViking memory disabled for this Athena run.",
                    warning_callback,
                )
                self._client = None
        except ImportError:
    ...
    def _extract_current_turn_messages(
        ...
        """Slice the completed turn out of Athena' full canonical transcript."""
        if not messages:
            return []
    ...
    def on_session_switch(
        ...
        **kwargs,
        ...
        and memory extraction never fires for it. See athena-agent#28296.
    ...
    def _tool_read(self, args: dict) -> str:
        ...
        # (e.g. viking://user/athena/.overview.md).
