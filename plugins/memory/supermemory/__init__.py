...
def _load_supermemory_config(athena_home: str) -> dict:
...
class SupermemoryMemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        ...
        # All other options are documented for $ATHENA_HOME/supermemory.json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._turn_count = 0
        self._config = _load_supermemory_config(self._athena_home)
