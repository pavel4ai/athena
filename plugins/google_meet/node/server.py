...
``$ATHENA_HOME/workspace/meetings/node_token.json``. Subsequent boots
...
def _default_token_path() -> Path:
    return Path(get_athena_home()) / "workspace" / "meetings" / "node_token.json"
...
class NodeServer:
    ...
    def __init__(
        ...
        display_name: str = "athena-meet-node",
    ) -> None:
        self.host = host
        self.port = port
