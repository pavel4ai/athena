...
_SESSION_CWD: ContextVar = ContextVar("ATHENA_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Athena source tree, a
    legitimate workspace when developing Athena; fallback-directory policy lives in the caller."""
