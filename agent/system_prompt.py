...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    # Some execution modes (cron) still want ATHENA_HOME persona while keeping
    ...
    stable_parts.append(ATHENA_AGENT_HELP_GUIDANCE)
    ...
    # ATHENA_KANBAN_TASK env var). Normal chat sessions never see
    ...
    # under so it doesn't conflate ~/.athena/skills/ (default profile) with
    # ~/.athena/profiles/<active>/skills/ (this profile's). Deterministic
    ...
    if active_profile == "default":
        stable_parts.append(
            ...
            "under ~/.athena/profiles/<name>/. Each profile has its own "
        ...
        stable_parts.append(
            ...
            f"and writes ~/.athena/profiles/{active_profile}/. The default "
            f"profile's data lives at ~/.athena/skills/, ~/.athena/plugins/, "
            f"~/.athena/cron/, ~/.athena/memories/ — those belong to a "
