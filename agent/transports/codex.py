...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Athena's web-provider config and
        ...
        # native search engine for xAI sessions instead of Athena's
        # configured web provider (Tavily/etc.), and those results bypass
        # Athena's tool-trace / citation plumbing (they arrive baked into the
