...
class CodexAppServerSession:
    ...
    def __init__(
        ...
        *,
        ...
        self._permission_profile = (
            permission_profile or _ATHENA_TO_CODEX_PERMISSION_PROFILE.get(
                os.environ.get("ATHENA_TERMINAL_SECURITY_MODE", "auto"),
                "workspace-write",
            )
        )
    ...
    def ensure_started(self) -> str:
        ...
        self._client.initialize(
            ...
            client_version=_get_athena_version(),
        )
    ...
    def _handle_server_request(self, req: dict) -> None:
        ...
        if method == "item/commandExecution/requestApproval":
            ...
            # OAuth, form data). For our own athena-tools callback we
