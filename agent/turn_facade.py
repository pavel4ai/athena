...
class TurnFacadeMixin:
    ...
    def run_conversation(
        ...
        from athena_cli.observability.relay_shared_metrics import finish_task_run, start_task_run
        ...
        try:
            ...
            # A host that owns this thread (Athena Console) may cancel the turn cross-thread.
