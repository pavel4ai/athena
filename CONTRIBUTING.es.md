...
Si tu habilidad es especializada, contribuida por la comunidad o de nicho, es mejor para un **Skills Hub** — súbela a un registro de habilidades y compártela en el [Discord de Futurebound Corp.](https://futurebnd.com). Los usuarios pueden instalarla con `athena skills install`.
...
├── website/                  # Sitio de documentación (futurebnd.com)
│
...
- **Discord**: [discord.gg/FutureboundCorp](https://futurebnd.com) — para preguntas, mostrar proyectos y compartir habilidades
