...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Athena session"),
        ...
        _cmd("status", "Show Athena session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Athena agent"),
        ...
        _cmd("update", "Update Athena Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Athena gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Athena session in it",
