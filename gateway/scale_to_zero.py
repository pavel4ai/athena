...
SCALE_TO_ZERO_ENV = "ATHENA_SCALE_TO_ZERO"  # stamped by NAS when the Labs toggle is on
...
def dashboard_client_heartbeat_path(athena_home: Optional[os.PathLike | str] = None):
    """Path of the dashboard-client liveness marker under ATHENA_HOME."""
    if athena_home is None:
        from athena_constants import get_athena_home
        athena_home = get_athena_home()
    return Path(athena_home) / DASHBOARD_CLIENT_HEARTBEAT_REL
