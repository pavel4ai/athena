...
class GatewayKanbanWatchersMixin:
    ...
    async def _kanban_notifier_watcher(self, interval: float = 5.0) -> None:
        ...
        **Multi-board:** iterates every board discovered on disk per
        ...
        if env_override in {"0", "false", "no", "off"}:
            logger.info("kanban notifier: disabled via ATHENA_KANBAN_DISPATCH_IN_GATEWAY env")
            return
        try:
            cfg = _load_config()
        ...
        while self._running:
            try:
                def _collect():
                    ...
                    # ATHENA_KANBAN_DB pins the board path; without this guard
    ...
    async def _kanban_dispatcher_watcher(self) -> None:
        ...
        # watcher here. Honours ATHENA_KANBAN_DISPATCH_IN_GATEWAY env var
        ...
        def _auto_decompose_tick(auto_decompose_per_tick: int) -> int:
            ...
            """
            try:
                from athena_cli import kanban_decompose as _decomp
            ...
            for b in boards:
                ...
                prev_env = os.environ.get("ATHENA_KANBAN_BOARD")
                try:
                    os.environ["ATHENA_KANBAN_BOARD"] = slug
                    try:
                    ...
                    if prev_env is None:
                        ...
                        os.environ["ATHENA_KANBAN_BOARD"] = prev_env
            return successes
