import { Box, type ScrollBoxHandle, stringWidth, Text } from '@athena/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (ATHENA_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ATHENA_DEV_CREDITS), lowest priority,
