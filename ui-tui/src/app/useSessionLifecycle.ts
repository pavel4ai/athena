...
import type { ScrollBoxHandle } from '@athena/ink'
import { evictInkCaches } from '@athena/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ATHENA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
