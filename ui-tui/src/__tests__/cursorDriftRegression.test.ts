 ...
 *
 * Symptom: in `athena --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@athena/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using athena --tui and as i type multiline my caret at the end will often ' +
