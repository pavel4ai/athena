 ...
 * across theme x background scenes to <tmpdir>/athena-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@athena/ink'
...
// The regenerated slate light_colors block from athena_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/athena-agent',
...
const setup = (bgHex: string) => {
  process.env.ATHENA_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
