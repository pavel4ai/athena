...
DEFAULT_UA = (
    "athena-osint-investigation/0.2 "
    "(+https://github.com/pavel4ai/athena; "
    "set ATHENA_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("ATHENA_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
