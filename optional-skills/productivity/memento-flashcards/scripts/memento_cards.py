...
Data file: $ATHENA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ATHENA_HOME = Path(os.environ.get("ATHENA_HOME", Path.home() / ".athena"))
DATA_DIR = _ATHENA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
