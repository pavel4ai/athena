...
A user would:
1. Set `API_SERVER_ENABLED=true` in `~/.athena/.env`
2. Run `athena gateway` (API server starts alongside Telegram/Discord/etc.)
...
Authorization: Bearer athena-api-key-here
