...
Real config files in a temp ATHENA_HOME, real resolution chains (no mocked
...
def voice_home(tmp_path, monkeypatch):
    """Isolated ATHENA_HOME + reloaded config modules; yields a config writer."""
    ...
    for var in (
        ...
        "DEEPINFRA_API_KEY", "ATHENA_LOCAL_STT_LANGUAGE",
    ):
