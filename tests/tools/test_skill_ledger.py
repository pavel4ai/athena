...
def ledger_env(tmp_path, monkeypatch):
    """Isolated ATHENA_HOME + skills dir for skill_manage and the ledger."""
    ...
    monkeypatch.setattr(skill_ledger, "get_athena_home", lambda: home)
    monkeypatch.setattr(skill_usage, "get_athena_home", lambda: home)
...
def test_rollback_refuses_paths_outside_athena_home(ledger_env):
    """A hand-edited ledger entry pointing outside ATHENA_HOME must not
