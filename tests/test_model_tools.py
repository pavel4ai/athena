...
class TestHandleFunctionCall:
    ...
    def test_registry_exception_emits_terminal_tool_hook(self, monkeypatch):
        from athena_cli import lifecycle

        hook_calls = []
        monkeypatch.setattr("athena_cli.plugins.invoke_hook", lambda *_args, **_kwargs: [])
...
class TestDisabledToolsetsPostureToolset:
    ...
    not own -- same non-core-delta subtraction as athena-* bundles (#33924) --
