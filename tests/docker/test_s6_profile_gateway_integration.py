...
The unit tests in tests/athena_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned athena-writable by the
...
from athena_cli.service_manager import S6ServiceManager
