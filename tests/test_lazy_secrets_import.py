"""Regression test: athena update must not load cryptography eagerly."""
...
assert 'athena_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running athena update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so athena_cli is importable,
