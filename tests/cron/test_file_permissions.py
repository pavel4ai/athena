...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("athena_cli.config.get_config_path", return_value=config_path), \
             patch("athena_cli.config.ensure_athena_home"):
    ...
    def test_ensure_athena_home_sets_0700(self):
        home = Path(self.tmpdir) / ".athena"
