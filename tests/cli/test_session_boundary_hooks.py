...
from athena_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/athena_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("athena_cli.lifecycle.invoke_hook")
@patch("athena_cli.lifecycle.finalize_session")
