...
def test_monitor_shortcuts_preserve_draft_and_respect_modal_prompts(monkeypatch):
    ...
    from athena_cli import cli_subagent_monitor as monitor
    ...
    monkeypatch.setenv('ATHENA_DEFER_AGENT_STARTUP', '1')
    cli = AthenaCLI(model='fixture', provider='openai-compat', api_key='fixture',
