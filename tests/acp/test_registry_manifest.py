...
def test_agent_json_matches_official_registry_required_fields():
    ...
    assert data["repository"] == "https://github.com/pavel4ai/athena"
    assert data["website"].startswith("https://github.com/pavel4ai/athena/")
    assert data["authors"] == ["Futurebound Corp."]
