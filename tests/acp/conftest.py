...
Keeps the ACP server tests offline: ``AthenaACPAgent._build_model_state``
calls ``athena_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import athena_cli.inventory as inventory
