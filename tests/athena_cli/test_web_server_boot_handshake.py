...
Simulates a slow athena_cli.gateway import (15-30 s on a fresh Windows install
...
1. _lifespan fire-and-forget: patched _warm_gateway_module sleeps N seconds in
   ...
   blocked, ATHENA_DASHBOARD_READY would fire immediately).
...
def test_lifespan_warmup_is_nonblocking():
    ...
    ATHENA_DASHBOARD_READY would have fired without delay.
    """
