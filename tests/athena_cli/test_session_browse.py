"""Tests for the interactive session browser (`athena sessions browse`).
...
from athena_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """athena sessions browse should be parseable."""
