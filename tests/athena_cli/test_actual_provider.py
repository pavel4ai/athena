...
from athena_cli.providers import normalize_provider as normalize_overlay_provider
...
def test_actual_profile_fetch_models_normalizes_env_base_url(monkeypatch):
    ...
    monkeypatch.setattr("athena_cli.urllib_security.open_credentialed_url", _open)
...
def test_actual_oneshot_reasoning_override_reaches_agent(monkeypatch):
    ...
    monkeypatch.setattr(
        "athena_cli.mcp_startup.ensure_mcp_discovery_before_agent_build",
        lambda **_kwargs: None,
    )
