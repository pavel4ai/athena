...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from athena_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ATHENA_OVERLAYS
        overlay = ATHENA_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify athena doctor recognizes Xiaomi env vars."""
