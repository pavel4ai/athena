"""Regression: ``athena update`` should take a managed checkout off autocrlf=true.
...
``athena update`` has to repair them.
...
from athena_cli.update_cmd import _normalize_managed_eol
