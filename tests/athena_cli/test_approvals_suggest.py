"""Tests for ``athena approvals suggest`` (athena_cli/approvals_suggest.py).

Approval history in Athena is implied, not ledgered: the session DB
...
from athena_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
