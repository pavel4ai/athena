...
from athena_cli.backup import verify_sqlite_integrity
...
class TestPreUpdateBackupIntegrityGuard:
    ...
    ATHENA_HOME whose state.db is corrupted mid-flight (#68474)."""
    ...
    def test_healthy_db_stays_quiet(self, athena_home, capsys):
    ...
    def test_zeroed_db_after_snapshot_is_loud(self, athena_home, capsys, monkeypatch):
