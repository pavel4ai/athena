...
The oneshot path builds its AIAgent directly (bypassing AthenaCLI), so the
...
from athena_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
