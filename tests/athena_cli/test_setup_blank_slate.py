"""Tests for Blank Slate setup mode (athena_cli/setup.py).
...
from athena_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
