"""Tests for the specifier module + `athena kanban specify` CLI surface.
...
from athena_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `athena kanban …` argparse surface directly."""
