...
The main() function in athena_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `athena -c model`
...
def _build_parser():
    """Build a minimal replica of the athena top-level parser."""
