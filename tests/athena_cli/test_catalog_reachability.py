...
Run before any catalog commit:
    ...
    ATHENA_TEST_NETWORK=1 scripts/run_tests.sh tests/athena_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("ATHENA_TEST_NETWORK"),
    reason="network test; set ATHENA_TEST_NETWORK=1 to run",
)
