...
def test_has_npx_agent_browser_true_when_npx_resolves():
    ...
    from athena_cli.dep_ensure import _has_npx_agent_browser
...
def test_find_agent_browser_lazy_install_cycle_terminates(monkeypatch):
    ...
    from athena_cli import dep_ensure
    ...
    monkeypatch.setattr(dep_ensure, "_has_athena_agent_browser", lambda: False)
...
def test_ensure_dependency_uses_powershell_on_windows(tmp_path):
    ...
    with patch("athena_cli.dep_ensure._DEP_CHECKS", {"node": lambda: False}), \
