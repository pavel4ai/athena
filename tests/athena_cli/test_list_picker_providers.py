...
import athena_cli.model_switch_providers as athena_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(athena_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("athena_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import athena_cli.models as hm
    import athena_cli.models_catalog_static as athena_cli_models_catalog_static
    from athena_cli import models_catalog_static
    ...
    monkeypatch.setattr(athena_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
