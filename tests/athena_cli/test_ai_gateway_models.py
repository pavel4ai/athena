...
where athena's shared picker expects ``prompt`` / ``completion``; these tests
pin the translation and the curated-list filtering.
"""
import json
from unittest.mock import patch, MagicMock

from athena_cli import models as models_module
from athena_cli import models_pricing
from athena_cli.models import VERCEL_AI_GATEWAY_MODELS, _ai_gateway_model_is_free, fetch_ai_gateway_models
from athena_cli.models_pricing import fetch_ai_gateway_pricing
