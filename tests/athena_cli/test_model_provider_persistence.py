...
class TestProviderPersistsAfterModelSave:
    ...
    def test_api_key_provider_saved_when_model_was_string(self, config_home, monkeypatch):
        ...
        from athena_cli.model_setup_flows import _model_flow_api_key_provider
...
class TestBaseUrlValidation:
    ...
    def test_empty_base_url_keeps_default(self, config_home, monkeypatch):
        ...
        with patch("athena_cli.auth._prompt_model_selection", return_value="MiniMax-M2"), \
             patch("athena_cli.auth.deactivate_provider"), \
             patch("builtins.input", return_value=""):
...
class TestZaiEndpointPicker:
    ...
    def test_custom_proxy_rejects_invalid_url(self, config_home, monkeypatch, capsys):
        ...
        with patch("athena_cli.main_provider_setup._prompt_provider_choice", return_value=custom_idx), \
             patch("athena_cli.auth._prompt_model_selection", return_value="glm-5"), \
             patch("athena_cli.auth.deactivate_provider"), \
    ...
    def test_current_endpoint_is_default_choice(self, config_home, monkeypatch):
        ...
        from athena_cli.auth import ZAI_ENDPOINTS
        from athena_cli.model_setup_flows import _select_zai_endpoint
        ...
        with patch("athena_cli.main_provider_setup._prompt_provider_choice", side_effect=fake_choice):
