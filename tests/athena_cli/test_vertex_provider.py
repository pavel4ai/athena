...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (athena_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_athena_overlays():
    """athena_cli.providers.get_provider("vertex") backs
