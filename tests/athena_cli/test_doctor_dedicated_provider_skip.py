"""Regression: athena doctor must not run a generic Bearer-auth health
...
with HTTP 404. The dedicated check at athena_cli/doctor.py already covers
Anthropic with the right headers, so the pluggable profile must be
skipped by `_build_apikey_providers_list()`.

See: pavel4ai/athena#22346
"""

from __future__ import annotations
from athena_cli import doctor_connectivity
