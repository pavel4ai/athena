...
from athena_cli.commands import GATEWAY_KNOWN_COMMANDS, SUBCOMMANDS, gateway_help_lines, resolve_command
...
def _isolate_config(monkeypatch, home):
    ...
    monkeypatch.setenv("ATHENA_MANAGED_DIR", str(home / "missing-managed"))
    from athena_cli import managed_scope
    from athena_cli.config import _LOAD_CONFIG_CACHE, _RAW_CONFIG_CACHE
