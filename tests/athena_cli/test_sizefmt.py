"""Tests for the shared byte formatter (athena_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from athena_cli.backup import _format_size as backup
    from athena_cli.checkpoints import _fmt_bytes as checkpoints
    from athena_cli.sizefmt import format_bytes as doctor
