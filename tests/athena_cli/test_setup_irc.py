"""Tests for IRC gateway configuration via `athena setup gateway` UI.
...
class TestIRCFreshInstallDiscovery:
    ...
    def test_irc_status_configured_when_env_set(self, monkeypatch):
        ...
        try:
            ...
            monkeypatch.setenv("IRC_CHANNEL", "#athena")
            monkeypatch.setenv("IRC_NICKNAME", "athena-bot")
...
class TestIRCGatewaySetupFreshInstall:
    """Simulate the full `athena setup gateway` experience with IRC present."""
