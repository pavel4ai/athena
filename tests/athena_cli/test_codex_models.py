...
from athena_cli.codex_models import (
...
def test_picker_never_synthesizes_900k_for_pro_or_unknown_slugs():
    ...
    from athena_cli.codex_models import _finalize_codex_models
...
def test_model_command_prompts_to_reuse_or_reauthenticate_codex_session(monkeypatch, capsys):
    from athena_cli.model_setup_flows import _model_flow_openai_codex
