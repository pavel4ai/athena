"""Fetch-failure classification for `athena update` / `athena update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/pavel4ai/athena.git/':"
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `athena update` sit on
    ...
    from athena_cli import update_cmd_git
