"""Tests for `athena secrets bitwarden token` / `athena secrets onepassword token`.
...
from athena_cli import onepassword_secrets_cli as op_cli
from athena_cli import secrets_cli as bw_cli
