...
class TestCustomProviderModelSwitch:
    ...
    def test_custom_endpoint_switch_prunes_stale_model_config_pool_entry(
        ...
        from athena_cli.model_setup_flows import _model_flow_custom
        ...
        with patch(
            ...
            return_value={
             ...
             patch("athena_cli.secret_prompt.masked_secret_prompt", return_value="sk-new"), \
             patch("athena_cli.main_provider_setup._prompt_custom_api_mode_selection", return_value=""), \
             patch(
                 "builtins.input",
                 side_effect=[
    ...
    def test_picker_recognizes_current_provider_alias_when_name_differs(
        ...
        with patch(
            "athena_cli.main._prompt_provider_choice",
...
class TestCustomProviderDiscoverModels:
    ...
    def test_discover_false_with_only_singular_model_skips_probe(self, config_home):
        ...
        with patch("athena_cli.models.fetch_api_models") as mock_fetch, \
             patch("athena_cli.models_local.fetch_ollama_local_models") as mock_ollama, \
             patch("athena_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="1"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
