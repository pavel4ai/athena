...
class TestFallbackChain:
    ...
    PRIMARY = "https://github.com/pavel4ai/athena/docs/api/model-catalog.json"
    FALLBACK = (
...
class TestIntegrationWithModelsModule:
    ...
    def test_curated_nous_ids_falls_back_to_hardcoded_on_empty_catalog(
        ...
        from athena_cli import model_catalog
        from athena_cli.models import get_curated_nous_model_ids, _PROVIDER_MODELS
    ...
    def test_picker_nous_row_uses_curated_list(self, tmp_path, monkeypatch):
        ...
        importlib.reload(model_catalog)
        try:
            from athena_cli.model_switch import list_picker_providers
