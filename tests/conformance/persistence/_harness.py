...
def make_athena_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated ATHENA_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"athena-home-{journal_mode}"
