"""The `athena-agent` skill is what a running Athena knows about itself.

`website/` is never packaged, so an installed Athena has no local copy of the
user guide; skills ARE synced into `$ATHENA_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Athena can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "athena-agent"
