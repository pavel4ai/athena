...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and athena-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # athena-agent (tests/skills/)
]
