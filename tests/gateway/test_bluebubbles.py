...
class TestBlueBubblesHelpers:
    ...
    def test_default_mention_patterns_match_athena_variants(self, monkeypatch):
        ...
        assert not adapter._message_matches_mention_patterns("antiathena should not match")
