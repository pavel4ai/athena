...
def store(tmp_path, monkeypatch):
    ...
    ~/.athena/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at athena_state import time, before pytest's ATHENA_HOME monkeypatch
    fires — the autouse fixture's ATHENA_HOME override doesn't help here.)
    """
    import athena_state
