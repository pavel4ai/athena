"""Tests for _setup_feishu() in athena_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("athena_cli.config.save_env_value", side_effect=mock_save), \
         patch("athena_cli.config.get_env_value", side_effect=mock_get), \
         patch("athena_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("athena_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("athena_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("athena_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("athena_cli.cli_output.print_header"), \
         patch("athena_cli.cli_output.print_info"), \
         patch("athena_cli.cli_output.print_success"), \
         patch("athena_cli.cli_output.print_warning"), \
         patch("athena_cli.cli_output.print_error"), \
