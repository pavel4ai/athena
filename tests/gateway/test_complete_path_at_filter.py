...
def _reset_fuzzy_cache(monkeypatch):
    ...
    # via _load_cfg(), which resolves through _athena_home captured at module
    # import time — before the per-test ATHENA_HOME redirect applies. When the
