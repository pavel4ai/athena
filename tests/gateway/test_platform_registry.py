...
class TestPlatformsMerge:
    ...
    def test_get_all_platforms_includes_builtins(self):
        from athena_cli.platforms import get_all_platforms, PLATFORMS
...
class TestApplyYamlConfigFnDispatch:
    ...
    a tmp ATHENA_HOME, calls load_gateway_config(), and asserts the hook
    ...
    def _write_config(self, tmp_path, content: str):
        ...
        athena_home.mkdir()
        (athena_home / "config.yaml").write_text(content, encoding="utf-8")
        return athena_home
