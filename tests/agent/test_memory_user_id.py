...
class TestMem0UserIdScoping:
    ...
    def test_no_user_id_no_config_uses_athena_user(self):
        """Without user_id or config override, should default to 'athena-user'."""
        from plugins.memory.mem0 import Mem0MemoryProvider
        ...
        assert provider._user_id == "athena-user"
...
class TestAIAgentUserIdPropagation:
    ...
    def test_user_id_stored_on_agent(self):
        ...
        with patch.dict(os.environ, {"ATHENA_HOME": "/tmp/test_athena"}):
