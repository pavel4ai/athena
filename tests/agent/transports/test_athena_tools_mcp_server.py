"""Tests for the athena-tools-as-MCP server module surface.
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import athena_tools_mcp_server as m
    ...
    def test_expected_athena_specific_tools_listed(self):
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `athena chat -q` subprocesses; if they
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.athena_tools_mcp_server as m
