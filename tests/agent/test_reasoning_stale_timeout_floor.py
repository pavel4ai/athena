...
thinking phase.  Athena's default cloud-stream stale detector
(``ATHENA_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``ATHENA_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
