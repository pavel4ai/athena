...
Run from the PR worktree:
    ...
    cd ~/.athena/athena-agent/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.athena/athena-agent``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.athena/athena-agent
...
# Isolated ATHENA_HOME for the config write.
