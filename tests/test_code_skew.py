...
stale-module ImportError after ``athena update``.
"""
...
import athena_cli.web_routers.models as _rt_models
...
class TestModelSwitchSkewGuard:
    ...
    def test_guard_message_names_revs_and_restart(self, monkeypatch):
        ...
        assert "athena gateway restart" in msg
...
class TestModelOptionsSkewGuard:
    ...
    def test_fresh_dashboard_builds_payload_unchanged(self, monkeypatch):
        ...
        monkeypatch.setattr("athena_cli.inventory.load_picker_context", lambda: {})
