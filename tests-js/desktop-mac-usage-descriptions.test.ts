 ...
 *
 * Each entry is a key/value pair that lands in the packaged Athena.app's
 ...
 * "Athena wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Athena wants to access Music" when Athena never touches the Music
