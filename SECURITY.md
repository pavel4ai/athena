...
Report privately via [GitHub Security Advisories](https://github.com/pavel4ai/athena/security/advisories/new)
...
- Environment details (`athena version`, commit SHA, OS, Python
  version).
...
- **Documented break-glass settings.** Operator-selected trade-offs
  ...
  athena-home security, and similar. Reports against those
